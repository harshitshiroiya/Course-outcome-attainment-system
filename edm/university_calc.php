...
<body id="mainclass" class="cbp-spmenu-push-toright">
    <div class="main-content">
        ...
        <div id="page-wrapper">
        <div class="row">
            <h3 class="title1"><b>University Direct Method Calculation</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
...
//                         $sql= "Select `course_id`,`std_id`, ((`marks_university`.`theory`)/8) as th_1,((`marks_university`.`practical`)/8) as pr_1   FROM `marks_university` WHERE `marks_university`.`course_id`='$course_id' ";
                         ...
                         $sql ="SELECT count(*) as c1 FROM `marks_university` WHERE `theory` > '48' ";
                         $sql1 ="SELECT count(*) as c2 FROM `marks_university` WHERE `theory` > '0' ";
                         $sql2 ="SELECT count(*) as c3 FROM `marks_university` WHERE `practical` > '15' ";
                         $sql3 ="SELECT count(*) as c4 FROM `marks_university` WHERE `practical` > '0' ";
                        ...
                        $pr_t=array();
                         ...
                         echo "<br><br><br>";
                            ...
                            $c= number_format(($th/$th_t)*100,2);
                            //echo $c;
                            //echo "<br><br>";
                            $d = number_format(($c*40)/1000,2);
                            //echo $d;

                             //echo "<br><br>";

                            $e= number_format(($pr/$pr_t)*100,2);
                            //echo $e;
                            //echo "<br><br>";
                            $f = number_format(($e*60)/1000,2);
                            // echo $f;
                            ...
                            // echo "<br>ATTAINMENT LEVEL (THEORY)<br>";
                            // echo $c1;
                            ...
                            elseif ($e >= 60 && $e <= 65) {
                                ...
                                $e1=number_format($e/60,2);
                            }
                            // echo "<br>ATTAINMENT LEVEL (PRACTICAL)<br>";
                            // echo $e1; 



                            $final= number_format(($c1*40+$e1*60)/100,2); 
                            ...
                            // echo $final;
                                ...
                                echo "<tr><th>% of Students getting equal or more than 60% (THEORY):</th><td>".$c." %</td></tr>";
                                echo "<tr><th>ATTAINMENT LEVEL (THEORY):</th><td>".$c1."</td></tr>";
                                echo "<tr><th>% of Students getting equal or more than 60% (PRACTICAL/VIVA):</th><td>".$e." %</td></tr>";
                                echo "<tr><th>ATTAINMENT LEVEL (PRACTICAL):</th><td>".$e1."</td></tr>";
                                echo "<tr><th>ATTAINMENT LEVEL FOR UNIVERSITY OF '$course_id':</th><td>".$final."/3</td></tr>";
