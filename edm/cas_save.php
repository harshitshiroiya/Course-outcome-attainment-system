...
if($cas_type == "AGP")
{	
	$sql = "INSERT INTO `agp_transition`(`e_no`, `emailid`, `doc_id`, `old_agp`, `new_agp`, `wef_date`, `letter_no`, `file_url`) VALUES ('$e_id','$email','$doc_id','$old_agp','$new_agp','$wef_date','$letter_no','$po_file_url')";
}else if($cas_type == "Promotion")
{
	$sql = "INSERT INTO `promotion`(`e_no`, `emailid`, `doc_id`, `old_designation`, `new_designation`, `wef_date`, `letter_no`, `file_url`) VALUES ('$e_id','$email','$doc_id','$old_desig','$new_desig','$wef_date','$letter_no','$po_file_url')";
}
