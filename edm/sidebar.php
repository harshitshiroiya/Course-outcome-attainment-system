				...
				<div class="profile_details_left"><!--notifications of menu start -->
					<ul class="nofitications-dropdown">
						<li class="dropdown head-dpdn">
							<a href="http://localhost/edm/user_dashboard.php" class="dropdown-toggle" aria-expanded="false"><i class="fa fa-home"></i> Home</a>
						...
						<li class="dropdown head-dpdn">
							<a href="user_dashboard1.php" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Home</a>
							<ul class="dropdown-menu">
								<li>
									<div class="notification_header">
