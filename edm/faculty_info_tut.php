...
<body id="mainclass" class="cbp-spmenu-push-toright">
	<div class="main-content">
		...
		<div id="page-wrapper">
		<div class="row">
			<h3 class="title1">Faculty Information: Class and Batch wise Tutorials (<?php echo $_SESSION['course_id']; ?>):</h3>
				<div class="form-three widget-shadow">
				<div class=" panel-body-inputin">
				<form action="faculty_info_tut_save.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
				...
				<!------------- Display Table--------------->
				<div class="form-three widget-shadow">
				<h3>Faculty Information: Class and Batch wise Tutorials:</h3><br>
				<table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
				<thead>
				<tr>
				<th>Faculty Name</th><th>Class</th><th>Batch</th><th>Roll no. from</th><th>Roll no. to</th>
				...
				$course_qry="SELECT * FROM `faculty_info_tut` INNER JOIN `users` ON `users`.`e_no`=`faculty_info_tut`.`tchr_id` where `course_id`='$course_id' AND `term`='$term'";
	...
	<!-- Classie --><!-- for toggle left push menu script -->
		...
		<script>
			...
			function deleteCourseTchr(trans_id)
			{
				...
				xmlhttp.open("GET", "delete_faculty_info_tut.php?trans_id=" + trans_id, true);
				xmlhttp.send();
			}
		</script>
	<!-- //Classie --><!-- //for toggle left push menu script -->
