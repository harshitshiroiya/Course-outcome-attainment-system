	...
	<div class="main-content">
		...
		<div class="row">
			<h3 class="title1"><b>CO - Assignment Mapping</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
				...
				<form id="co_am_form" onsubmit="return checkTotal()" action="assignment_co_po_pso_save.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
				...
				<th><center>Assignment<Br>Questions</center></th>
                ...
                <tbody id="co_am">
                    <tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A1_1";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
				...
				{
					$co_no=$b+1;
					echo "<option value='".$co[$b]['co_id']."'>CO".$co_no."</option>";
				}
				?>	
				</select>
				</div>
				...
				<td><div class='form-group'><div class="col-md-12"><div class="input-group"><textarea name="pi_no[]" id="txtarea1" cols="50" rows="4" class="form-control1" required='required'></textarea></div></div></div></td>
					...
					<tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A1_2";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
                        <td><div class="form-group1 col-md-8">
				<select id="pso_select" name="co[]" class='form-control1' required="required"><option value=''>Select</option>
				...
				<td><div class='form-group'><div class="col-md-12"><div class="input-group"><textarea name="pi_no[]" id="txtarea1" cols="50" rows="4" class="form-control1" required='required'></textarea></div></div></div></td>
                    ...
                    <tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A1_3";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
                        <td><div class="form-group1 col-md-8">
				<select id="pso_select" name="co[]" class='form-control1' required="required"><option value=''>Select</option>
				...
				<td><div class='form-group'><div class="col-md-12"><div class="input-group"><textarea name="pi_no[]" id="txtarea1" cols="50" rows="4" class="form-control1" required='required'></textarea></div></div></div></td>
                    ...
                    <tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A1_4";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
                        <td><div class="form-group1 col-md-8">
				<select id="pso_select" name="co[]" class='form-control1' required="required"><option value=''>Select</option>
				...
				<td><div class='form-group'><div class="col-md-12"><div class="input-group"><textarea name="pi_no[]" id="txtarea1" cols="50" rows="4" class="form-control1" required='required'></textarea></div></div></div></td>
                    ...
                    <tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A2_1";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
                        <td><div class="form-group1 col-md-8">
				<select id="pso_select" name="co[]" class='form-control1' required="required"><option value=''>Select</option>
				...
				<td><div class='form-group'><div class="col-md-12"><div class="input-group"><textarea name="pi_no[]" id="txtarea1" cols="50" rows="4" class="form-control1" required='required'></textarea></div></div></div></td>
                    ...
                    <tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A2_2";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
                        <td><div class="form-group1 col-md-8">
				<select id="pso_select" name="co[]" class='form-control1' required="required"><option value=''>Select</option>
				...
				<td><div class='form-group'><div class="col-md-12"><div class="input-group"><textarea name="pi_no[]" id="txtarea1" cols="50" rows="4" class="form-control1" required='required'></textarea></div></div></div></td>
                    ...
                    <tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A2_3";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
                        <td><div class="form-group1 col-md-8">
				<select id="pso_select" name="co[]" class='form-control1' required="required"><option value=''>Select</option>
				...
				<td><div class='form-group'><div class="col-md-12"><div class="input-group"><textarea name="pi_no[]" id="txtarea1" cols="50" rows="4" class="form-control1" required='required'></textarea></div></div></div></td>
                    ...
                    <tr class='table_row1'>
                        <td><center><input type="text" name="A1_q[]" class="form-control1" value="<?php echo "A2_4";?>" readonly></center></td>
                        <td><center><input type="text" name="marks[]" class="form-control1" value="<?php echo "5";?>" readonly></center></td>
                        <td><center><div class='form-group'><div class='col-md-8'><select name='b[]' class='form-control1' required='required'><option value=''>Select</option><option value='1'>BL1</option><option value='2'>BL2</option><option value='3'>BL3</option><option value='4'>BL4</option><option value='5'>BL5</option><option value='6'>BL6</option></center></td>
                        <td><div class="form-group1 col-md-8">
				<select id="pso_select" name="co[]" class='form-control1' required="required"><option value=''>Select</option>
