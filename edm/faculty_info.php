	...
	<div class="main-content">
		...
		<div class="row">
			<h3 class="title1">Faculty Information: Class and Batch wise Tutorials (<?php echo $_SESSION['course_id']; ?>):</h3>
				...
				<form action="theory_course_tchr_save.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
				...
				<?php
					...
					echo "</select></div></div></td>";
				?>
				<td><div class='form-group'><div class="col-md-8"><div class="input-group"><input type="text" name="city" list="batch" class="form-control1" placeholder="Batch" required>
   					 <datalist id="batch">
      						<option value="A">
      						<option value="B">
      						<option value="C">
      						<option value="D">	
    				 </datalist></div></div></div></td>
