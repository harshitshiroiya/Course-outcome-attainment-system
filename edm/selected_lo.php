...
<button class="button"  onclick="window.location.href='http://localhost/edm/marks_exp.php'"><span>Marks for Experiment</span></button>&nbsp &nbsp
<button class="button"  onclick="window.location.href='http://localhost/edm/marks_assignment.php'"><span>Marks for Assignment</span></button>&nbsp &nbsp
<button class="button"  onclick="window.location.href='http://localhost/edm/marks_miniproject.php'"><span>Marks for Mini Project</span></button>
<br>
<br>
<button class="button"  onclick="window.location.href='http://localhost/edm/experiment_calc.php'"><span>Calculate LO for Experiment</span></button>&nbsp &nbsp
<button class="button"  onclick="window.location.href='http://localhost/edm/assignment_calc.php'"><span>Calculate LO for Assignment</span></button>&nbsp &nbsp
<button class="button"  onclick="window.location.href='http://localhost/edm/miniproject_calc.php'"><span>Calculate LO for Mini Project</span></button>
