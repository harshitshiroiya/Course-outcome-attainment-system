...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
		<div class="row">
			<h3 class="title1">Details of Qualification</h3>
			<!--<h5 class="title1"> Note: Plase Make .pdf of all your degree certificates ready before filling. If you do not have degree certificate upload .pdf of last semester's marksheet.</h5>
				<div class="form-three widget-shadow">
				<div class=" panel-body-inputin">
				<form class="form-horizontal" action="qual_save.php" enctype="multipart/form-data" method="POST">
				<div class="form-group">
					<label class="col-md-2 control-label">Qualification</label>
					<div class="col-md-8">
						<select name='qual_type' id='selector1' class='form-control1' required='required' onchange='setFields(this.value)'><option value=''>SELECT</option><option value='Diploma'>Diploma</option><option value='UG'>UG</option><option value='PG'>PG</option><option value='M.Phil.'>M.Phil.</option><option value='Ph.D.'>Ph.D.</option></select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name='ug_course_type' id='ug_course_type' class='form-control1'>
				...
				<div class="form-group">
					<label class="col-md-2 control-label">Course</label>
					<div class="col-md-8">
						<select name='pg_course_type' id='pg_course_type' class='form-control1'>
						<option value=''>SELECT</option>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type='text' name='specialization' class='form-control1' required='required' placeholder="Enter Specialization of Degree">
						</div>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-md-2 control-label" >Date of Passing</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</span>
							<input type='date' id='passing_month' name='passing_month' max="<?php //echo date("Y-m-d");?>" class='form-control1' required='required' onchange='checkDate()'>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							<input type='file' name='qual_file' class='form-control1' required='required'>
						</div>
					</div>
				</div>
				<center>
				...
				<table id="qualification_details" class="table table-hover">
				<thead>
				<tr>
				<th>Qualification</th><th>Course</th><th>Specialization</th><th>Month & Year of Passing</th><th>Certificate</th>
				</tr>
				</thead>
				<tbody id="qual_table">
				<?php
				...
				if(mysqli_num_rows($result)>0)
				{
					while($row = mysqli_fetch_assoc($result))
					{
						...
						echo "<tr><td>".$row['qual_type']."</td><td>".$row['course']."</td><td>".$row['specialisation']."</td><td>".$pass."</td><td><a target='_blank' href=".$row['file_url'].">View</a></td></tr>";
					}
				}
				?>
				</tbody>
...
function addField (argument) {
	...
	function setFields(type)
	{
		if(type=="UG")
		{
			document.getElementById("pg_course_type").required=false;
			document.getElementById("ug").style.display="block";
			document.getElementById("ug_course_type").required=true;
		...
		{
			document.getElementById("ug_course_type").required=false;
			document.getElementById("pg").style.display="block";
			document.getElementById("pg_course_type").required=true;
		...
		else
		{
			document.getElementById("pg").style.display="none";
			document.getElementById("ug").style.display="none";
			document.getElementById("selector2").required=false;
			document.getElementById("selector3").required=false;
		}
		
	}
	function deleteLetter(doc_id)
	{
		var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("qual_table").innerHTML = this.responseText;
            }
        };
        xmlhttp.open("GET", "delete_qual.php?doc_id=" + doc_id, true);
        xmlhttp.send();
	}
    </script>
	<!-- //for index page weekly sales java script -->
