	...
	<div class="main-content">
		...
		<div class="row">
			<h3 class="title1"><b>Facilities and Experiments Mapping</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
				...
				<form id="co_am_form" onsubmit="return checkTotal()" action="facility_mapping_save.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
				...
				$gap_qry= "SELECT `sr_no`,`category`,`details`,`reason`,`exp_no`,`no_hours`,`co_no`,`po` FROM `facility_mapping` WHERE `course_id`='$course_id'";
				$co_gap_qry="SELECT * FROM `facility_mapping` WHERE `course_id`='$course_id'";
				//echo $co_am_qry;
