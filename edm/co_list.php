	...
	<div class="main-content">
		...
		<div class="row">
			<h3 class="title1">List of Course Outcome (CO) (<?php echo $_SESSION['course_id']; ?>):</h3>
				...
				<thead>
				<tr>
				<th>CO No.</th><th>Unique CO No.</th><th>CO Statement</th><th>Blooms Taxonomy Level</th><th>% weightage</th><th>Mapping to<br>Syllabus<br>Modules</th><th>PSOs</th><th>Performance Indicator (PI) of PO (Enter comma separated list)</th>
				</tr>
				</thead>
				<?php
