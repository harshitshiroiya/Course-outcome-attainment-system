      ...
      <nav class="navbar navbar-inverse">
		...
		<div class="row">
			<h3 class="title1">Appointment Details :</h3>
				...
				<form action="appointment_save.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
				<div class="form-group">
					<label class="col-md-2 control-label">Appointment Type</label>
					<div class="col-md-8">
						<select name='app_type' id='selector1' class='form-control1' required='required' onchange='setFields(this.value)'><option value=''>SELECT</option><option value='Regular'>Regular</option><option value='Adhoc'>Adhoc</option></select>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label" id="dt_lable">Tenure Start Date</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</span>
							<input type='date' name='ten_start' class='form-control1' max="<?php //echo date("Y-m-d");?>" required='required' onchange="getEndDate(this.value)">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label" >Tenure End Date</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</span>
							<input type='date' name='ten_end' id='ten_end' class='form-control1' required='required'>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label">Appointment Letter Number</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class="fa fa-id-card"></i>
							</span>
							<input type='text' name='app_no' class='form-control1' required='required'>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label">Appointment Letter</label>
					<div class="col-md-8">
						<div class="input-group">							
							<input type="file" id="appointment_file" name="appointment_file" accept="application/pdf" required="required">
						</div>
					</div>
				</div>
				</div>
				...
				<thead>
				<tr>
				<th>Appointment Type</th><th>Tenure Start date/Joining Date</th><th>Tenure End date</th><th>Appointment Letter Number</th><th>Appointment Letter</th>
				</tr>
				</thead>
				<tbody id="app_table">
				<?php
				...
				if(mysqli_num_rows($result)>0)
				{
					while($row = mysqli_fetch_assoc($result))
					{
						...
						echo "<tr><td>".$row['appointment_type']."</td><td>".date("d/m/Y", strtotime($row['tsd']))."</td><td>".$ted."</td><td>".$row['letter_number']."</td><td><a target='_blank' href=".$row['file_url'].">View</a></td></tr>";
					}
				}
				?>
				</tbody>
...
function setFields(type)
	{
		...
		if(type=="Regular")
		{
			document.getElementById("ten_end").readOnly=true;
			document.getElementById("ten_end").value="";
			document.getElementById("dt_lable").innerHTML="Joining Date";
			document.getElementById("ten_end").style.backgroundColor = "#D3D3D3";
		}
		else if(type=="Adhoc")
		{
			document.getElementById("ten_end").readOnly=false;
			document.getElementById("ten_end").style.backgroundColor = "white";
		}
	...
	{
		document.getElementById("ten_end").min=val;
	}
	...
	function deleteLetter(doc_id)
	{
        ...
        xmlhttp.open("GET", "delete_app.php?doc_id=" + doc_id, true);
        xmlhttp.send();
	}
    </script>
	<!-- //for index page weekly sales java script -->
