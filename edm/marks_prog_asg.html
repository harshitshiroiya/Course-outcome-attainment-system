        ...
        <div class="row">
            <h3 class="title1"><b>Mini Project</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
                ...
                <div class="form-group">
                    ...
                    //     $flag=0;
                    // }
                    $lo_miniproject_qry="SELECT * FROM `faculty_info_lab` WHERE `course_id`='$course_id'";
                   
                    $lo_miniproject_result = mysqli_query($conn,$lo_miniproject_qry);
...
function StudentName(str1) {
  ...
  if (str1 == "") {
    ...
    xmlhttp.open("GET","get_student_name_miniproject.php?batch="+str1+"&class="+document.getElementById("selector1").value,true);
    xmlhttp.send();
  }
}
