...
<body id="mainclass" class="cbp-spmenu-push-toright">
    <div class="main-content">
        ...
        <div id="page-wrapper">
        <div class="row">
            <h3 class="title1"><b>University</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
                ...
                <div class="form-group">
                   ...
                   // $exp=array();
                    ...
                    //     $flag=0;
                    // }
                    $lo_university_qry="SELECT * FROM `faculty_info_lab` WHERE `course_id`='$course_id'";
                   
                    $lo_university_result = mysqli_query($conn,$lo_university_qry);
                    ...
                    echo "CLASS:";
                    echo "<select name='sem' id='selector1' class='form-control1' onchange=StudentName(this.value)>";
...
//         document.getElementById("selector1").innerHTML = this.responseText;
//       }

//     };
//     xmlhttp.open("GET","get_student_name_university.php?class="+str,true);
//     xmlhttp.send();
//   }
// }
...
//     };
//     xmlhttp.open("GET","get_student_name_university.php?class="+document.getElementById("tableid").value,true);
//     //xmlhttp.open("GET","get_student_name_university.php?class="+str,true);
//     xmlhttp.send();
//   }
// }
...
function StudentName(str) {
  ...
  if (str == "") {
    ...
    xmlhttp.open("GET","get_student_name_university.php?class="+document.getElementById("selector1").value,true);
    //xmlhttp.open("GET","get_student_name_university.php?class="+str,true);
    xmlhttp.send();
  }
}
