...
<body id="mainclass" class="cbp-spmenu-push-toright">
    <div class="main-content">
        ...
        <div id="page-wrapper">
        <div class="row">
            <h3 class="title1"><b>University InDirect Method Calculation - Programming Assignment</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
                ...
                <tbody>
                    <?php
                        ...
                        $sql ="SELECT count(*) as c1 FROM `marks_programming_assignment` WHERE `programming_assignment` > '12' ";
                        $sql1 ="SELECT count(*) as c2 FROM `marks_programming_assignment` WHERE `programming_assignment` > '0' ";
                        ...
                        $mp_t=array();
                         ...
                         echo "<br><br><br>";
                            ...
                            // echo $final;
                                ...
                                echo "<tr><th>ATTAINMENT LEVEL (PROGRAMMING ASSIGNMNET):</th><td>".$c1."</td></tr>";
                                echo "<tr><th>ATTAINMENT LEVEL FOR PROGRAMMING ASSIGNMNET OF '$course_id':</th><td>".$final."/3</td></tr>";
