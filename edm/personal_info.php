				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="fname" class="form-control1" readonly="readonly">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="fname" class="form-control1" placeholder="Full Name">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="desig" class="form-control1" placeholder="Designation">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="selector1" class="col-sm-2 control-label">Department </label>
					<div class="col-sm-8"><select name="dept" id="selector1" class="form-control1">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="date" name="doj" class="form-control1">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="radio" class="col-sm-2 control-label">Currunt Appointment Type</label>
						<div class="col-sm-8">
						<div class="radio-inline"><label><input type="radio" name="type" value="regular" onclick="javascript:salaryCheck(this.value);"> Regular</label></div>
						<div class="radio-inline"><label><input type="radio" name="type" value="adhoc" onclick="javascript:salaryCheck(this.value);"> Adhoc</label></div>
						</div>
				</div>
				<div id="salary" style="display:none;">
				<div class="form-group">
					<label class="col-md-2 control-label">Currunt Basic Pay</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class='fa fa-rupee'></i>
							</span>
							<input type="number" name="basic" class="form-control1" placeholder="Basic Pay" oninput="validity.valid ||(value='');">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="selector1" class="col-sm-2 control-label">Currunt AGP </label>
					<div class="col-sm-8">
					<select name="agp" id="selector1" class="form-control1">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="number" name="salary" class="form-control1" placeholder="Consolidated Salary" oninput="validity.valid ||(value='');">
						</div>
					</div>
				</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="pan" class="form-control1" maxlength="10" oninput="validity.valid ||(value='');" placeholder="PAN Card Number">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="aadhar" class="form-control1" pattern="^[0-9]*$" maxlength="12" oninput="validity.valid ||(value='');" placeholder="Aadhar Card Number">
						</div>
					</div>
				</div>
				</form>
