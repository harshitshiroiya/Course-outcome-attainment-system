      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              <li class="treeview">
                <a href="course_teacher_info.php">
                <i class="fa fa-graduation-cap"></i> <span>Faculty Information</span>
                </a>
              </li>
			  <li class="treeview">
                <a href="define_coursesic.php">
                <i class="fa fa-graduation-cap"></i> <span>Define Course Outcomes</span>
                </a>
              </li>
			  </ul>
      </nav>
			...
			<a class="navbar-brand" href="index.html"><img width="100%" src="images/edm_logo.png"></a><br/><br/>
				...
				<div class="profile_details_left"><!--notifications of menu start -->
					<ul class="nofitications-dropdown">
						...
						<li class="dropdown head-dpdn">
							<a href="course_home.php" class="dropdown-toggle" aria-expanded="false"><i class="fas fa-chalkboard"></i> Course Home </a>
						</li>
						<!--<li class="dropdown head-dpdn">
