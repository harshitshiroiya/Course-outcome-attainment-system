...
<body id="mainclass" class="cbp-spmenu-push-toright">
    <div class="main-content">
        ...
        <div id="page-wrapper">
        <div class="row">
            <h3 class="title1"><b>Experiment</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
...
function StudentName(str1) {
  ...
  if (str1 == "") {
    ...
    xmlhttp.open("GET","get_student_name.php?batch="+str1+"&class="+document.getElementById("selector1").value,true);
    xmlhttp.send();
  }
}
