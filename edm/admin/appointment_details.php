      ...
      <nav class="navbar navbar-inverse">
		...
		<div class="row">
			<h3 class="title1">Appointment Details :</h3>
				...
				<thead>
				<tr>
				<th>Appointment Type</th><th>Tenure Start date/Joining Date</th><th>Tenure End date</th><th>Appointment Letter Number</th><th>Appointment Letter</th><th></th>
				</tr>
				</thead>
				<tbody id="app_table">
				<?php
				$qry="SELECT * FROM `appointment_details` WHERE e_no='$e_id' or emailid='$email'";
