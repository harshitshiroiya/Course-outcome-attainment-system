...
if($app_type=="Regular")
{	
	$sql = "INSERT INTO `appointment_details`(`e_no`, `emailid`,`doc_id`,`appointment_type`, `tsd`, `letter_number`, `file_url`) VALUES ('$e_id','$email','$doc_id','$app_type','$ten_start','$app_no','$po_file_url')";
}else if($app_type=="Adhoc")
{
	$sql = "INSERT INTO `appointment_details`(`e_no`, `emailid`,`doc_id`,`appointment_type`, `tsd`, `ted`, `letter_number`, `file_url`) VALUES ('$e_id','$email','$doc_id','$app_type','$ten_start','$ten_end','$app_no','$po_file_url')";
}
