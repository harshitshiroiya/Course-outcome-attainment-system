      ...
      <nav class="navbar navbar-inverse">
		...
		<div class="row">
			...
			<h5 class="title1"> Note: Plase Make .pdf of all your degree certificates ready before filling. If you do not have degree certificate upload .pdf of last semester's marksheet.</h5>
				...
				<thead>
				<tr>
				<th>Qualification</th><th>Course</th><th>Specialization</th><th>Month & Year of Passing</th><th>Certificate</th><th></th>
				</tr>
				</thead>
				<tbody id="qual_table">
				<?php
				$qry="SELECT * FROM `qual_details` WHERE e_no='$e_id' or emailid='$email'";
