...
//echo $po_file_url;
$sql = "INSERT INTO `training_info`(`e_no`, `emailid`, `doc_id`, `course_type`, `title`, `duration`, `from_date`, `to_date`, `certificate_url`) VALUES ('$e_id','$email','$doc_id','$course_type','$course_title','$duration','$from_date','$to_date','$po_file_url')";
