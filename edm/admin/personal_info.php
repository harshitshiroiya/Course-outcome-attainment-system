...
if(mysqli_num_rows($result)>0)
{
	while($row = mysqli_fetch_assoc($result))
	{
		...
		$pan=$row["panno"];
		$aadhar=$row["aadharno"];
		$curr_qual=$row["qualification"];
		$joining_qual=$row["qualification_join"];
	}
}
?>
<!DOCTYPE HTML>
      ...
      <nav class="navbar navbar-inverse">
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									...
									<div class="user-name">
										<p>Admin<?php// echo $name; ?></p>
										<span>Admin<?php //echo $designation; ?></span>
									</div>
		...
		<div class="row">
			<h3 class="title1">Personal Information :</h3>
				...
				<form action="personal_info.php" class="form-horizontal" action="GET">
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="fname" class="form-control1" value="<?php echo $e_id; ?>" readonly="readonly">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="fname" class="form-control1" value="<?php echo $name; ?>" placeholder="Full Name" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="desig" class="form-control1" value="<?php echo $designation; ?>" placeholder="Designation" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="selector1" class="col-sm-2 control-label">Department </label>
					<div class="col-sm-8"><select name="dept" id="selector1" class="form-control1" required>
						<option value="">--SELECT--</option>
						<option value="ADMINISTRATION" <?php if($dept=="ADMINISTRATION") echo 'selected="selected"';?>>ADMINISTRATION</option>
						<option value="CHEMISTRY" <?php if($dept=="CHEMISTRY") echo 'selected="selected"';?>>CHEMISTRY</option>
						<option value="COMMUNICATION SKILLS" <?php if($dept=="COMMUNICATION SKILLS") echo 'selected="selected"';?>>COMMUNICATION SKILLS</option>
						<option value="COMPUTER" <?php if($dept=="COMPUTER") echo 'selected="selected"';?>>COMPUTER ENGINEERING</option>
						<option value="ELECTRONICS" <?php if($dept=="ELECTRONICS") echo 'selected="selected"';?>>ELECTRONICS ENGINEERING</option>
						<option value="ELECTRONICS & TELECOMMUNICATION" <?php if($dept=="ELECTRONICS & TELECOMMUNICATION") echo 'selected="selected"';?>>ELECTRONICS & TELECOMMUNICATION</option>
						<option value="ENGINEERING SCIENCE" <?php if($dept=="ENGINEERING SCIENCE") echo 'selected="selected"';?>>ENGINEERING SCIENCE</option>
						<option value="HUMANITIES S.S." <?php if($dept=="HUMANITIES S.S.") echo 'selected="selected"';?>>HUMANITIES S.S.</option>
						<option value="INFORMATION TECHNOLOGY" <?php if($dept=="INFORMATION TECHNOLOGY") echo 'selected="selected"';?>>INFORMATION TECHNOLOGY</option>
						<option value="LIBRARY" <?php if($dept=="LIBRARY") echo 'selected="selected"';?>>LIBRARY</option>
						<option value="MATHS" <?php if($dept=="MATHS") echo 'selected="selected"';?>>MATHEMATICS</option>
						<option value="MECHANICALS" <?php if($dept=="MECHANICALS") echo 'selected="selected"';?>>MECHANICAL</option>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="date" name="doj" value="<?php echo $doj; ?>" class="form-control1" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="selector1" class="col-sm-2 control-label">Current Qualification </label>
					<div class="col-sm-8">
					<select name="curr_qual" id="selector1" class="form-control1" required>
						<option value="">--SELECT--</option>
						<option value="Diploma" <?php if($curr_qual=="Diploma") echo 'selected="selected"';?>>Diploma</option>
						<option value="UG" <?php if($curr_qual=="UG") echo 'selected="selected"';?>>Under Graduate Degree</option>
						<option value="PG" <?php if($curr_qual=="PG") echo 'selected="selected"';?>>Post Graduate Degree</option>
						<option value="Doctorate" <?php if($curr_qual=="Doctorate") echo 'selected="selected"';?>>Doctorate</option>
						<option value="Post Doctorate" <?php if($curr_qual=="Post Doctorate") echo 'selected="selected"';?>>Post Doctorate</option>
					</select></div>
				</div>
				<div class="form-group">
					<label for="selector1" class="col-sm-2 control-label">Qualification while joining </label>
					<div class="col-sm-8">
					<select name="joining_qual" id="selector1" class="form-control1" required>
						<option value="">--SELECT--</option>
						<option value="Diploma" <?php if($joining_qual=="Diploma") echo 'selected="selected"';?>>Diploma</option>
						<option value="UG" <?php if($joining_qual=="UG") echo 'selected="selected"';?>>Under Graduate Degree</option>
						<option value="PG" <?php if($joining_qual=="PG") echo 'selected="selected"';?>>Post Graduate Degree</option>
						<option value="Doctorate" <?php if($joining_qual=="Doctorate") echo 'selected="selected"';?>>Doctorate</option>
						<option value="Post Doctorate" <?php if($joining_qual=="Post Doctorate") echo 'selected="selected"';?>>Post Doctorate</option>
					</select></div>
				</div>
				<div class="form-group">
					<label for="radio" class="col-sm-2 control-label">Current Appointment Type</label>
						<div class="col-sm-8">
						<div class="radio-inline"><label><input type="radio" name="type" value="Regular" <?php echo ($type =='Regular')? 'checked':'' ?> onclick="javascript:salaryCheck(this.value);" required> Regular</label></div>
						<div class="radio-inline"><label><input type="radio" name="type" value="Adhoc" <?php echo ($type =='Adhoc')? 'checked':'' ?> onclick="javascript:salaryCheck(this.value);" required> Adhoc</label></div>
						</div>
				</div>
				<div id="salary" style="<?php echo ($type =='Regular')? 'display:block;':'display:none;' ?>">
				<div class="form-group">
					<label class="col-md-2 control-label">Current Basic Pay</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class='fa fa-rupee'></i>
							</span>
							<input type="number" name="basic" class="form-control1" placeholder="Basic Pay" oninput="validity.valid ||(value='');" <?php echo ($type =='Regular')? 'required=required':'' ?>>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="selector1" class="col-sm-2 control-label">Current AGP </label>
					<div class="col-sm-8">
					<div class="input-group input-icon right">
					<span class="input-group-addon">
	<i class="fa fa-rupee"></i>
</span>
					<select name="agp" id="selector1" class="form-control1" <?php echo ($type =='Regular')? 'required=required':'' ?>>
				...
				<div id="cons" style="<?php echo ($type =='Adhoc')? 'display:block;':'display:none;' ?>">
				<div class="form-group">
					<label class="col-md-2 control-label">Consolidated Salary</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class="fa fa-rupee"></i>
							</span>
							<input type="number" name="salary" class="form-control1" placeholder="Consolidated Salary" oninput="validity.valid ||(value='');" <?php echo ($type =='Adhoc')? 'required=required':'' ?>>
						</div>
					</div>
				</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="date" name="dob" value="<?php echo $dob; ?>" class="form-control1" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">							
							...
							<input type="text" name="pan" value="<?php echo $pan; ?>" class="form-control1" maxlength="10" oninput="validity.valid ||(value='');" placeholder="PAN Card Number" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label">Aadhar Card Number</label>
					<div class="col-md-8">
						<div class="input-group">							
							<span class="input-group-addon">
								<i class="fa fa-id-card-o"></i>
							</span>
							<input type="text" name="aadhar" value="<?php echo $aadhar; ?>" class="form-control1" pattern="^[0-9]*$" maxlength="12" oninput="validity.valid ||(value='');" placeholder="Aadhar Card Number" required>
						</div>
					</div>
				</div>
				<center>
