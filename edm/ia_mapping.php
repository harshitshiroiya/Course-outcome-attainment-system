				...
				else
				{
					if (mysqli_num_rows($co_result) > 0) 
					{
						while($co_row = mysqli_fetch_assoc($co_result))
						{
							...
							for($y=0;$y<sizeof($am_nm);$y++)
							{
								echo "<td><div class='form-group'><div class='col-md-10'><div class='input-group'><input type='number' name='".$am_nm[$y]."[]' class='form-control1' value=0 max='100' min='0' onchange='calculateSum(this)' oninput='validity.valid || (value=0);'></div></div></div></td>";
							}
