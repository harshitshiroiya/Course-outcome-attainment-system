...
<body id="mainclass" class="cbp-spmenu-push-toright">
    <div class="main-content">
        ...
        <div id="page-wrapper">
        <div class="row">
            <h3 class="title1"><b>Assignment</b> (<?php echo $_SESSION['course_id']; ?>):</h3>
                ...
                <div class="form-group">
                    ...
                    //     $flag=0;
                    // }
                    $lo_assignment_qry="SELECT * FROM `faculty_info_lab` WHERE `course_id`='$course_id'";
...
function StudentName(str1) {
  ...
  if (str1 == "") {
    ...
    xmlhttp.open("GET","get_student_name_assignment.php?batch="+str1+"&class="+document.getElementById("selector1").value,true);
    xmlhttp.send();
  }
}
